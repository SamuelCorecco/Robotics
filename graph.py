...
graph.node_information('A', [1, 0, 1, 0])
graph.add_edge('A', 'B', 'E', 1)
graph.node_information('B', [1, 0, 0, 1])
graph.add_edge('B', 'C', 'N', 1)
graph.node_information('C', [0, 1, 0, 1])
graph.add_edge('C', 'D', 'O', 2)
graph.node_information('D', [0, 1, 1, 0])

# print next node to explore from B
print(graph.closest_unexplored('B'))
# print next node to explore from C
print(graph.closest_unexplored('C'))
